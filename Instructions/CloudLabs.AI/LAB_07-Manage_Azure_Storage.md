...
1. Note that, at this point, the Storage account has only the primary location.
...
1. Click **+ Container** and create a container with the following settings and click Create:
